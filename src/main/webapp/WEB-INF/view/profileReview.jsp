...
<div class="content">
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col">
                <form action="${pageContext.request.contextPath}/profile/review" method="get">
                    <input name="id" value="${requestScope.user.id}" hidden>
                                        ...
                                        <div class="col d-flex justify-content-end me-2 align-self-center">
                                            <c:choose>
                                                <c:when test="${receipt.paid == true}">
                                                    <button class="btn btn-success disabled"><fmt:message key="lang.paid"/></button>
                                                </c:when>
                                                <c:otherwise>
                                                    <button class="btn btn-danger disabled"><fmt:message key="lang.unpaid"/></button>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </div>
